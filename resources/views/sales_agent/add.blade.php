...
@section('title', 'Add Sales Agent - ' . env('WEBSITE_NAME'))
@section('content')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <select id="" class="select2 form-select" data-placeholder="Select Agent Type">
                                    ...
                                    <label for="select2Basic">Agent Type <span class="text-danger">*</span></label>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="number" class="form-control" id="sales_target" placeholder="Enter Annual Sales Target" name="sales_target">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <select id="target_unit" name="target_unit" class="select2 form-select" data-placeholder="Commission Structure">
                                        <option value="Percentage on Sales">Percentage on Sales</option>
                                        <option value="Fixed per Order">Fixed per Order (₹)</option>
                                    </select>
                                    <label for="name">Commission Structure</label>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="number" class="form-control" id="commission_value" placeholder="Enter Commission Value" name="sales_target">
                            ...
                            <div class="col-lg-12 text-end">
                                ...
                                <a href="{{ url('sales_agent') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
