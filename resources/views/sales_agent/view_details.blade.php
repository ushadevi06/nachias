                    ...
                    <div class="d-flex align-items-center flex-column flex-sm-row gap-2">
                        <div class="text-center text-sm-start">
                            ...
                            <div class="d-flex flex-wrap gap-2 justify-content-center justify-content-sm-start">
                                <span class="badge {{ $salesAgent->status == 'Active' ? 'bg-success' : 'bg-danger' }} d-inline-flex align-items-center">
                                    <i class="ri ri-checkbox-circle-line me-1" style="vertical-align: middle; line-height: 1;"></i> {{ $salesAgent->status }}
                                </span>
                                <span class="badge bg-label-secondary d-inline-flex align-items-center">
                                    <i class="ri ri-map-pin-line me-1" style="vertical-align: middle; line-height: 1;"></i> {{ $salesAgent->city->city_name ?? '-' }}, {{ $salesAgent->state->state_name ?? '-' }}
                                </span>
                            </div>
                        </div>
                    </div>
