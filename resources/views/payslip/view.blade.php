...
@section('title', 'Payslip Generation - ' . env('WEBSITE_NAME'))
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="table-header-box">
                ...
                <a class="btn btn-primary" href="{{ url('add_payslip') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-box">
                                            <a href="{{ url('add_payslip') }}" class="btn btn-edit"><i class="icon-base ri ri-edit-box-line"></i></a>
