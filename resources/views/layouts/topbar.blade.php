                                    ...
                                    <li
                                        ...
                                        <ul class="menu-sub">
                                            ...
                                            @if($isSuper || $user->can('view store-categories') || $user->can('view raw-materials') || $user->can('view standard-consumption') || $user->can('view brand-categories') || $user->can('view brands') || $user->can('view items'))
                                                ...
                                                <li
                                                    class="menu-item {{ (request()->is('store_categories*') || request()->is('raw_materials*') || request()->is('standard_consumptions*') || request()->is('brand_categories*') || request()->is('brands*') || request()->is('items*') || request()->is('item_prices*')) ? 'active' : '' }}">
                                                    <a href="javascript:void(0)" class="menu-link menu-toggle">
                                                        <div>Item Setup</div>
                                                    </a>
