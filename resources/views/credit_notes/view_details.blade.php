            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    @if($creditNote->reference_doc)
                        <a href="{{ url('uploads/credit_notes/' . $creditNote->reference_doc) }}" target="_blank" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card border-0 shadow-sm h-100" style="border-radius: 12px; background-color: #fcfcfc;">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-0 text-dark small" style="white-space: pre-line; line-height: 1.6;">{{ $creditNote->remarks }}</p>
                        </div>
                    </div>
                    @endif
                </div>
