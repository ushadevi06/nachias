...
<head>
    <meta charset="utf-8">
    <title>Accessories Consumption - {{ $jobCard->job_card_no }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1 class="company-name">{{ $web_settings->company_name ?? 'Nachias' }}</h1>
        <div class="company-address">{{ $web_settings->address ?? '' }}</div>
    </div>

    <div class="title">Accessories Consumption</div>
