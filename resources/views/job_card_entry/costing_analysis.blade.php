                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                            <span class="avatar-initial rounded bg-label-primary"><i class="ri ri-t-shirt-line"></i></span>
                        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-start border-success border-3">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                            <span class="avatar-initial rounded bg-label-success"><i class="ri ri-money-dollar-circle-line"></i></span>
                        </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 border-start border-warning border-3">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2">
                        <div class="avatar avatar-sm flex-shrink-0 me-2">
                            <span class="avatar-initial rounded bg-label-warning"><i class="ri ri-price-tag-3-line"></i></span>
                        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <i class="ri ri-scissors-cut-line text-primary me-2 fs-4"></i>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <i class="ri ri-ink-bottle-line text-info me-2 fs-4"></i>
                                        <div>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <i class="ri ri-settings-4-line text-warning me-2 fs-4"></i>
                                        <div>
