            ...
            <div class="modal-body p-4">
                <form id="editItemForm">
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                                <input type="text" id="modal_item" class="form-control" readonly placeholder="Item">
...
<div class="modal fade" id="missingPricesModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-danger p-3">
                <h5 class="modal-title text-white"><i class="ri-error-warning-line me-1"></i> Attention: Missing Pricing</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4">
                <p class="mb-3">The following items generated by this Job Card do not have their pricing set up in the <b>Item Prices</b> master. Please add them.</p>
                <ul class="mb-0" id="modalMissingPricesList">
                </ul>
            </div>
