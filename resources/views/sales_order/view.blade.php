                    ...
                    <div class="filter-box">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <select name="customer_id" id="filter_customer" class="form-select select2" data-placeholder="Select Customer">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <select name="status" id="filter_status" class="form-select select2" data-placeholder="Select Status">
                            ...
                            <div class="col-md-4 col-lg-3">
                                <input type="text" id="so_date_range" class="form-control" placeholder="Select SO Date Range">
                            </div>
                            <div class="col-md-3">
