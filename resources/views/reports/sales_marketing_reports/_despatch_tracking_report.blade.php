    ...
    <div class="table-responsive">
        <table class="datatables-products table premium-table table-hover text-nowrap">
            <thead class="bg-light">
                <tr>
                    <th class="text-center sticky-col-sno">S.No</th>
                    <th class="sticky-col-so">Sales Order No</th>
                    <th class="sticky-col-axe">OrderAxe Order No</th>
                    <th>Order Type</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="text-center sticky-col-sno">{{ $index + 1 }}</td>
                    <td class="fw-bold text-primary sticky-col-so">{{ $order->so_no }}</td>
                    <td class="sticky-col-axe">{{ $order->order_no ?? '-' }}</td>
