    ...
    <table class="table premium-table mb-0 datatables-consumption">
        <thead>
            <tr>
                ...
                <th class="text-center">WASTAGE (MTR)</th>
        ...
        <tfoot>
            <tr class="bg-light fw-bold">
                ...
                <td id="footer-consumption-wastage" class="text-center text-primary">0.00</td>
    ...
    $(document).ready(function() {
        ...
        $table.DataTable({
            ...
            columns: [
                ...
                { data: 'wastage', className: 'text-center' },
            ...
            drawCallback: function(settings) {
                ...
                if (json && json.totals) {
                    var garments = parseFloat((json.totals.total_garments || '0').replace(/,/g, ''));
                    var fabric = parseFloat((json.totals.total_fabric || '0').replace(/,/g, ''));
                    var avg = garments > 0 ? (fabric / garments).toFixed(3) : '0.000';

                    $('#footer-consumption-fabric').html(json.totals.total_fabric || '0.00');
                    $('#footer-consumption-wastage').html(json.totals.total_wastage || '0.00');
                    $('#footer-consumption-garments').html(json.totals.total_garments || '0');
