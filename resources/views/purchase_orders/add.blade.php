                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="number" class="form-control @error('commission') is-invalid @enderror" id="commission" name="commission" step="0.01" placeholder="Enter Commission (%)" value="{{ old('commission', $purchaseOrder->commission ?? '') }}" min="0">
                                    ...
                                    @if(old('items'))
                                        @foreach(old('items') as $index => $item)
                                            <tr class="item-row">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control supplier_design_name @error('items.' . $index . '.supplier_design_name') is-invalid @enderror" name="items[{{ $index }}][supplier_design_name]" value="{{ $item['supplier_design_name'] ?? '' }}" placeholder="Enter Supplier Design Name">
                                                ...
                                                <td>
                                                    <input type="number" class="form-control quantity @error('items.' . $index . '.quantity') is-invalid @enderror" name="items[{{ $index }}][quantity]" step="0.01" value="{{ $item['quantity'] ?? '' }}" min="0">
                                                ...
                                                <td class="td-gst td-cgst d-none">
                                                    <input type="number" class="form-control cgst_percent text-end @error('items.' . $index . '.cgst_percent') is-invalid @enderror" name="items[{{ $index }}][cgst_percent]" step="0.01" min="0" value="{{ $item['cgst_percent'] ?? 0 }}">
                                                ...
                                                <td class="td-gst td-sgst d-none">
                                                    <input type="number" class="form-control sgst_percent text-end @error('items.' . $index . '.sgst_percent') is-invalid @enderror" name="items[{{ $index }}][sgst_percent]" step="0.01" min="0" value="{{ $item['sgst_percent'] ?? 0 }}">
                                                ...
                                                <td class="td-gst td-igst d-none">
                                                    <input type="number" class="form-control igst_percent text-end @error('items.' . $index . '.igst_percent') is-invalid @enderror" name="items[{{ $index }}][igst_percent]" step="0.01" min="0" value="{{ $item['igst_percent'] ?? 0 }}">
                                                ...
                                                <td>
                                                    <input type="number" class="form-control amount" name="items[{{ $index }}][amount]" step="0.01" min="0" value="{{ ($item['quantity'] ?? 0) * ($item['rate'] ?? 0) }}">
                                                </td>
                                                <td>
                                    ...
                                    @elseif($purchaseOrder && $purchaseOrder->items->count() > 0)
                                        @foreach($purchaseOrder->items as $index => $item)
                                            <tr class="item-row">
                                                ...
                                                <td>
                                                    <input type="number" class="form-control quantity @error('items.' . $index . '.quantity') is-invalid @enderror" name="items[{{ $index }}][quantity]" step="0.01" min="0" value="{{ $item->quantity }}">
                                                    @error('items.' . $index . '.quantity')
                                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                ...
                                                <td class="td-gst td-cgst d-none">
                                                    <input type="number" class="form-control cgst_percent text-end @error('items.' . $index . '.cgst_percent') is-invalid @enderror" name="items[{{ $index }}][cgst_percent]" step="0.01" min="0" value="{{ $item->cgst_percent }}">
                                                    @error('items.' . $index . '.cgst_percent')
                                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                ...
                                                <td class="td-gst td-sgst d-none">
                                                    <input type="number" class="form-control sgst_percent text-end @error('items.' . $index . '.sgst_percent') is-invalid @enderror" name="items[{{ $index }}][sgst_percent]" step="0.01" min="0" value="{{ $item->sgst_percent }}">
                                                    @error('items.' . $index . '.sgst_percent')
                                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                ...
                                                <td class="td-gst td-igst d-none">
                                                    <input type="number" class="form-control igst_percent text-end @error('items.' . $index . '.igst_percent') is-invalid @enderror" name="items[{{ $index }}][igst_percent]" step="0.01" min="0" value="{{ $item->igst_percent }}">
                                                    @error('items.' . $index . '.igst_percent')
                                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                                    @enderror
                                                </td>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control amount" name="items[{{ $index }}][amount]" step="0.01" min="0" value="{{ $item->amount }}">
                                                </td>
                                                <td>
                                    ...
                                    @else
                                        <tr class="item-row">
                                           ...
                                           <td>
                                            ...
                                            <td>
                                                <input type="number" class="form-control quantity" name="items[0][quantity]" step="0.01" placeholder="Enter Quantity" min="0">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control rate" name="items[0][rate]" step="any" min="0" placeholder="Enter Rate">
                                            </td>
                                            <td class="td-gst td-cgst d-none">
                                                <input type="number" class="form-control cgst_percent text-end @error('items.0.cgst_percent') is-invalid @enderror" name="items[0][cgst_percent]" step="0.01" min="0" value="">
                                                @error('items.0.cgst_percent')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </td>
                                            <td class="td-gst td-cgst d-none">
                                            ...
                                            <td class="td-gst td-sgst d-none">
                                                <input type="number" class="form-control sgst_percent text-end @error('items.0.sgst_percent') is-invalid @enderror" name="items[0][sgst_percent]" step="0.01" min="0" value="">
                                                @error('items.0.sgst_percent')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </td>
                                            <td class="td-gst td-sgst d-none">
                                            ...
                                            <td class="td-gst td-igst d-none">
                                                <input type="number" class="form-control igst_percent text-end @error('items.0.igst_percent') is-invalid @enderror" name="items[0][igst_percent]" step="0.01" min="0" value="">
                                                @error('items.0.igst_percent')
                                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                                @enderror
                                            </td>
                                            <td class="td-gst td-igst d-none">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating form-floating-outline text-black">
                                            ...
                                            <small class="text-muted d-block mt-2">Max file size: 2MB per file.
                                                Supported: JPG, PNG, WEBP, PDF, DOC, DOCX</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-4">
                                    <div class="col-12">
                                        ...
                                        <div class="mb-2">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="input-group input-group-sm" style="width:120px;">
                                                    <input type="number" class="form-control form-control-sm text-end @error('discount_percent') is-invalid @enderror" id="discount_percent" name="discount_percent" step="0.01" value="{{ old('discount_percent', $purchaseOrder->discount_percent ?? 0) }}" min="0">
                                        ...
                                        <div id="negative_net_warning" class="alert alert-warning text-dark py-1 px-2 mb-1 d-none" style="font-size: 12px;">
                                        ...
                                        <div class="igst-field tax-percent-input {{ old('other_state', $purchaseOrder && $purchaseOrder->other_state ? 'yes' : 'no') == 'yes' ? '' : 'd-none' }}">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="input-group input-group-sm" style="width:120px;">
                                                    <input type="number" class="form-control form-control-sm text-end @error('igst_percent') is-invalid @enderror" id="igst_percent" name="igst_percent" step="0.01" value="{{ old('igst_percent', $purchaseOrder->igst_percent ?? (!empty($web_settings->igst) ? $web_settings->igst : '')) }}" min="0">
                                                    <span class="input-group-text px-1">%</span>
                                                </div>
                                            </div>
                                            @error('igst_percent')
                                        ...
                                        <div class="igst-field {{ old('other_state', $purchaseOrder && $purchaseOrder->other_state ? 'yes' : 'no') == 'yes' ? '' : 'd-none' }} mt-1">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <label class="fw-medium">IGST Amount:</label>
                                        ...
                                        <div class="cgst-field tax-percent-input {{ old('other_state', $purchaseOrder && $purchaseOrder->other_state ? 'yes' : 'no') == 'no' ? '' : 'd-none' }}">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="input-group input-group-sm" style="width:120px;">
                                                    <input type="number" class="form-control form-control-sm text-end @error('cgst_percent') is-invalid @enderror" id="cgst_percent" name="cgst_percent" step="0.01" value="{{ old('cgst_percent', $purchaseOrder->cgst_percent ?? (!empty($web_settings->cgst) ? $web_settings->cgst : '')) }}" min="0">
                                                    <span class="input-group-text px-1">%</span>
                                                </div>
                                            </div>
                                            @error('cgst_percent')
                                        ...
                                        <div class="cgst-field {{ old('other_state', $purchaseOrder && $purchaseOrder->other_state ? 'yes' : 'no') == 'no' ? '' : 'd-none' }} mt-1">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <label class="fw-medium">CGST Amount:</label>
                                        ...
                                        <div class="sgst-field tax-percent-input {{ old('other_state', $purchaseOrder && $purchaseOrder->other_state ? 'yes' : 'no') == 'no' ? '' : 'd-none' }} mt-2">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <div class="input-group input-group-sm" style="width:120px;">
                                                    <input type="number" class="form-control form-control-sm text-end @error('sgst_percent') is-invalid @enderror" id="sgst_percent" name="sgst_percent" step="0.01" value="{{ old('sgst_percent', $purchaseOrder->sgst_percent ?? (!empty($web_settings->sgst) ? $web_settings->sgst : '')) }}" min="0">
                                                    <span class="input-group-text px-1">%</span>
                                                </div>
                                            </div>
                                            @error('sgst_percent')
                                        ...
                                        <div class="sgst-field {{ old('other_state', $purchaseOrder && $purchaseOrder->other_state ? 'yes' : 'no') == 'no' ? '' : 'd-none' }} mt-1">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <label class="fw-medium">SGST Amount:</label>
                                                <input type="text" class="form-control-plaintext text-end w-50" id="summary_sgst_amount" readonly>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.add_item', function () {
                ...
                let firstRowWidthVal = $('#item-rows tbody tr:first').find('.fabric_width').val();
