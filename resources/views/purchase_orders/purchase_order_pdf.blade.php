...
<body>
    <div class="container">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td width="50%"
                    style="padding: 0; vertical-align: top; border-right: 1px solid #000; border-bottom: none;">
                ...
                <td width="50%" style="padding: 0; vertical-align: top; border-bottom: none;">
                    <table class="no-border" style="margin: 0; width: 100%;">
                        ...
                        <tr>
                            <td>Ref Date</td>
                            <td>:</td>
                            <td>{{ $purchaseOrder->reference_date ? $purchaseOrder->reference_date->format('d/m/Y') : '-' }}
                            </td>
                        </tr>
                        <tr>
                            <td>Agent</td>
                    ...
                    <table class="no-border" style="width: 100%;">
                        ...
                        @if($purchaseOrder->commission > 0)
                            <tr>
                                ...
                                <td class="text-right" style="padding: 4px;">
                                    {{ number_format($purchaseOrder->taxable_amount * ($purchaseOrder->commission / 100), 2) }}
                                </td>
                            </tr>
                        @endif
