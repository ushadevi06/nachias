                        ...
                        <div class="filter-box">
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-lg-3">
                                    <select name="supplier_id" id="filter_supplier" class="form-select select2"
                                        data-placeholder="Select Supplier">
                                        <option value="">Select Supplier</option>
                                        @foreach($suppliers as $supplier)
                                            <option value="{{ $supplier->id }}">{{ $supplier->name }} ({{ $supplier->code }})
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4 col-lg-3">
                                    <select name="invoice_status" id="filter_status" class="form-select select2"
