    ...
    <div class="card">
        <div class="card-body">
            <div class="row g-4 align-items-start">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-floating form-floating-outline mb-3">
                                <select id="payment_mode" name="payment_mode"
                                    class="select2 form-select @error('payment_mode') is-invalid @enderror"
                                    data-placeholder="Select Payment Mode">
                                    <option value="">Select Payment Mode</option>
                                    <option value="Bank Transfer"
                                        {{ old('payment_mode', $invoice->payment_mode ?? '') == 'Bank Transfer' ? 'selected' : '' }}>
                                        Bank Transfer
                                    </option>
                                    <option value="Cheque"
                                        {{ old('payment_mode', $invoice->payment_mode ?? '') == 'Cheque' ? 'selected' : '' }}>
                                        Cheque
                                    </option>
                                    <option value="UPI"
                                        {{ old('payment_mode', $invoice->payment_mode ?? '') == 'UPI' ? 'selected' : '' }}>
                                        UPI
                                    </option>
                                    <option value="Cash"
                                        {{ old('payment_mode', $invoice->payment_mode ?? '') == 'Cash' ? 'selected' : '' }}>
                                        Cash
                                    </option>
                                </select>
                ...
                $otherState = old(
                'other_state',
                isset($invoice) && $invoice->other_state ? 'Y' : 'N'
                );
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <div class="input-group input-group-sm" style="width:120px;">
                                    <input type="number"
                                        ...
                                        id="discount_input"
                                        class="form-control text-end @error('discount_percent') is-invalid @enderror"
                                        value="{{ $discountPercent }}"
                                        min="0" max="100" step="0.01" {{ isset($invoice) ? 'readonly' : '' }}>
