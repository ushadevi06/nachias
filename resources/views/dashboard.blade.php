...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="badge bg-white text-dark border px-3 py-2 shadow-sm d-flex align-items-center">
                    ...
                    <span class="small fw-semibold">{{ date('d M, Y') }} | FY
                        {{ date('m') >= 4 ? date('Y') . '-' . (date('y') + 1) : (date('Y') - 1) . '-' . date('y') }}</span>
                </div>
                <button type="button" class="btn btn-sm btn-white border shadow-sm" onclick="window.location.reload();"
        ...
        @php
            ...
            $canProduction = auth()->id() == 1 || auth()->user()->can('view-production dashboard') || (auth()->user()->department_id == 3);
        ...
        @if($canSalesOrders || $canFinanceHr || $canProduction || $canStockMaterial || $canSuppliersMaint)
            <div class="mb-4">
                <ul class="nav nav-pills dashboard-nav-pills p-2 bg-white rounded-3 shadow-sm border flex-nowrap overflow-auto"
                    id="dashboardTabs" role="tablist" style="scrollbar-width: thin; gap: 8px;">
                    @if($canSalesOrders)
                        <!-- Tab 1: Sales & Orders -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold px-3 py-2 text-nowrap" id="tab-sales-orders-tab" data-bs-toggle="tab"
                                data-bs-target="#tab-sales-orders" type="button" role="tab" aria-controls="tab-sales-orders"
                                aria-selected="false">
                    ...
                    @if($canFinanceHr)
                        <!-- Tab 2: Finance & HR -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold px-3 py-2 text-nowrap" id="tab-finance-hr-tab" data-bs-toggle="tab"
                                data-bs-target="#tab-finance-hr" type="button" role="tab" aria-controls="tab-finance-hr"
                                aria-selected="false">
                    ...
                    @if($canProduction)
                        <!-- Tab 3: Production -->
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold px-3 py-2 text-nowrap" id="tab-production-tab" data-bs-toggle="tab"
                                data-bs-target="#tab-production" type="button" role="tab" aria-controls="tab-production"
                                aria-selected="false">
                    ...
                    @if($canStockMaterial)
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold px-3 py-2 text-nowrap" id="tab-stock-material-tab" data-bs-toggle="tab"
                                data-bs-target="#tab-stock-material" type="button" role="tab" aria-controls="tab-stock-material"
                                aria-selected="false">
                    ...
                    @if($canSuppliersMaint)
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link fw-bold px-3 py-2 text-nowrap" id="tab-suppliers-maintenance-tab"
                                data-bs-toggle="tab" data-bs-target="#tab-suppliers-maintenance" type="button" role="tab"
                                aria-controls="tab-suppliers-maintenance" aria-selected="false">
        ...
        <div class="tab-content" id="erpDashboardTabsContent">
            ...
            @if(!$canSalesOrders && !$canFinanceHr && !$canProduction && !$canStockMaterial && !$canSuppliersMaint)
                <div class="card border-0 shadow-sm p-4 text-center my-4">
                    <div class="py-5">
                        ...
                        <p class="text-muted small mb-0">You do not have permission to view any dashboard tabs. Please contact
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <span class="text-danger small fw-bold"><i class="ri-alert-line"></i> Action
                                                    Required</span>
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h4 class="mb-0 fw-bold text-warning">
                                                    ₹{{ number_format($year_missed_value, 2) }}</h4>
                                                <span class="text-muted small">{{ number_format($year_missed_qty) }} Items
                                                    Pending</span>
                                            </div>
                                            <div class="kpi-icon bg-light-warning">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white py-3 border-bottom d-flex justify-content-between align-items-center">
                            <h6 class="mb-0 fw-bold text-dark">
                                <i class="ri ri-line-chart-line me-2 text-primary"></i>Sales, Collection, Purchase & Payment
                                Trends
                            </h6>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6 border-end">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <span class="badge bg-label-success">Collection Perf:
                                            {{ $collection_performance }}%</span>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-between align-items-center mb-2 ps-lg-2">
                                        ...
                                        <span class="badge bg-label-primary">Total:
                                            ₹{{ formatIndianCurrency($total_purchase) }}</span>
                                    </div>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-lg-12">
                                <div class="card border-0 shadow-sm mb-4">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold text-primary"><i class="ri ri-team-line me-2"></i>Debtors
                                        ...
                                        <div class="table-responsive" style="max-height: 380px; overflow-y: auto;">
                                            <table class="table table-hover align-middle mb-0">
                                                ...
                                                <tbody class="small">
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="6" class="text-center text-muted py-3">No pending debtors
                                                                found for any zone.</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                            </table>
                            ...
                            <div class="col-lg-8">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold text-danger"><i class="ri ri-store-line me-2"></i>Creditors
                                            Outstanding & Aging Report</h6>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-xl col-md-4 col-sm-6">
                                <div class="card attendance-card border-0 shadow-sm h-100"
                                ...
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold text-dark"><i
                                                class="ri-pie-chart-2-fill text-danger me-2"></i>Attendance Summary & Device
                                            Filter</h6>
                                        <select id="attendanceDeviceFilter"
                                            class="form-select form-select-sm w-auto shadow-none">
                                            <option value="All">All Devices</option>
                                            @foreach($dbDevices as $device)
                                                <option value="{{ $device->device_name ?: $device->serial_number }}">
                                                    {{ $device->device_name ?: $device->serial_number }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="card-body">
            ...
            @if($canProduction)
                ...
                <div class="tab-pane fade" id="tab-production" role="tabpanel" aria-labelledby="tab-production-tab">
                    <div class="mb-4">
                        ...
                        <!-- ========================================================================= -->
                        <!-- CUTTING DASHBOARD (TODAY'S OPERATIONS ONLY - CURRENT DATE)                -->
                        <!-- ========================================================================= -->
                        <div class="card border-0 shadow-sm mb-4" id="cuttingDashboardCard"
                            style="border-radius: 12px; overflow: hidden; border: 1px solid #fed7aa !important;">
                            <div class="card-header py-3 px-3 px-md-4 border-bottom d-flex flex-wrap justify-content-between align-items-center gap-2"
                                style="background: linear-gradient(135deg, #fffaf5 0%, #fff7ed 100%);">
                                <div>
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="badge bg-warning text-dark px-2 py-1 fw-bold">
                                            <i class="ri ri-scissors-cut-line me-1"></i> CUTTING DEPARTMENT
                                        </span>
                                        <h5 class="mb-0 fw-bold text-dark">Cutting Dashboard</h5>
                                        <span class="badge bg-white text-dark border shadow-sm small">
                                            <i class="ri ri-calendar-check-line text-warning me-1"></i> Today:
                                            {{ date('d M, Y') }}
                                        </span>
                                    </div>
                                    <p class="text-muted small mb-0 mt-1">This is the ERP home screen for the Cutting Department
                                        — showing real-time cutting related data for today only.</p>
                                </div>
                                <div class="d-flex align-items-center gap-2">
                                    <button type="button"
                                        class="btn btn-sm btn-primary d-flex align-items-center gap-1 shadow-sm fw-semibold"
                                        data-bs-toggle="modal" data-bs-target="#cuttingJobCardsModal">
                                        <i class="ri ri-file-list-3-line"></i>
                                        <span>Active Job Cards ({{ $cutting_total_job_cards ?? 0 }})</span>
                                    </button>
                                </div>
                            </div>
                            <div class="card-body p-3 p-md-4 bg-white">
                                <!-- 1. KPI Cards (Top) Section Header -->
                                <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                                    <h6 class="fw-bold text-dark mb-0 d-flex align-items-center">
                                        <i class="ri ri-dashboard-3-line text-warning me-2 fs-5"></i> 1. KPI Cards (Top)
                                    </h6>
                                    <span class="text-muted x-small">Metrics updated live for {{ date('d M, Y') }}</span>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card border-0 shadow-sm h-100"
                                            style="background: linear-gradient(145deg, #ffffff, #fffdfa); border-left: 5px solid #f59e0b !important; border-radius: 10px;">
                                            <div class="card-body p-3">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <p class="text-muted small fw-bold mb-1 d-flex align-items-center">
                                                            <span class="fs-5 me-1">🧑</span> Employees Present
                                                        </p>
                                                        <h3 class="mb-1 fw-bold text-dark">
                                                            {{ $cutting_emp_present ?? 0 }} <span
                                                                class="fs-6 fw-normal text-muted">/
                                                                {{ $cutting_emp_total ?? 0 }}</span>
                                                        </h3>
                                                        <span class="badge bg-soft-warning text-dark x-small fw-semibold">
                                                            {{ ($cutting_emp_total ?? 0) > 0 ? round((($cutting_emp_present ?? 0) / $cutting_emp_total) * 100) : 0 }}%
                                                            Present in Cutting Dept
                                                        </span>
                                                    </div>
                                                    <div class="rounded-circle p-2 d-flex align-items-center justify-content-center"
                                                        style="background: #fef3c7; width: 44px; height: 44px;">
                                                        <i class="ri ri-user-follow-line text-warning fs-5"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card border-0 shadow-sm h-100"
                                            style="background: linear-gradient(145deg, #ffffff, #faf5ff); border-left: 5px solid #8b5cf6 !important; border-radius: 10px;">
                                            <div class="card-body p-3">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <p class="text-muted small fw-bold mb-1 d-flex align-items-center">
                                                            <span class="fs-5 me-1">✂️</span> Pieces Cut
                                                        </p>
                                                        <h3 class="mb-1 fw-bold text-primary">
                                                            {{ number_format($cutting_pieces_cut ?? 0) }} <span
                                                                class="fs-6 fw-normal text-muted">Pcs</span>
                                                        </h3>
                                                        <span class="text-muted x-small">Total pieces cut today</span>
                                                    </div>
                                                    <div class="rounded-circle p-2 d-flex align-items-center justify-content-center"
                                                        style="background: #f3e8ff; width: 44px; height: 44px;">
                                                        <i class="ri ri-scissors-2-line text-primary fs-5"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- 4. Active Job Cards (with completed) -->
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card border-0 shadow-sm h-100"
                                            style="background: linear-gradient(145deg, #ffffff, #f0fdfa); border-left: 5px solid #06b6d4 !important; border-radius: 10px; cursor: pointer;"
                                            data-bs-toggle="modal" data-bs-target="#cuttingJobCardsModal"
                                            title="Click to view all job cards">
                                            <div class="card-body p-3">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <p class="text-muted small fw-bold mb-1 d-flex align-items-center">
                                                            <span class="fs-5 me-1">📄</span> Active Job Cards
                                                            <i class="ri ri-arrow-right-up-line text-muted ms-1 small"></i>
                                                        </p>
                                                        <h3 class="mb-1 fw-bold text-info">
                                                            {{ $cutting_active_job_cards ?? 0 }} <span
                                                                class="fs-6 fw-normal text-muted">Active</span>
                                                        </h3>
                                                        <div class="d-flex align-items-center gap-1">
                                                            <span
                                                                class="badge bg-soft-success text-success x-small fw-semibold">{{ $cutting_completed_job_cards ?? 0 }}
                                                                Completed</span>
                                                            <span
                                                                class="text-muted x-small">({{ $cutting_total_job_cards ?? 0 }}
                                                                Total)</span>
                                                        </div>
                                                    </div>
                                                    <div class="rounded-circle p-2 d-flex align-items-center justify-content-center"
                                                        style="background: #ccfbf1; width: 44px; height: 44px;">
                                                        <i class="ri ri-file-text-line text-info fs-5"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- 5. Target (Today's Cutting Target) -->
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card border-0 shadow-sm h-100"
                                            style="background: linear-gradient(145deg, #ffffff, #fef2f2); border-left: 5px solid #ef4444 !important; border-radius: 10px;">
                                            <div class="card-body p-3">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <p class="text-muted small fw-bold mb-1 d-flex align-items-center">
                                                            <span class="fs-5 me-1">🎯</span> Target (Today)
                                                        </p>
                                                        <h3 class="mb-1 fw-bold text-danger">
                                                            {{ number_format($cutting_target ?? 0) }} <span
                                                                class="fs-6 fw-normal text-muted">Pcs</span>
                                                        </h3>
                                                        <span class="text-muted x-small">Today's cutting target</span>
                                                    </div>
                                                    <div class="rounded-circle p-2 d-flex align-items-center justify-content-center"
                                                        style="background: #fee2e2; width: 44px; height: 44px;">
                                                        <i class="ri ri-focus-3-line text-danger fs-5"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <!-- 6. Completed (Today's Cutting Completed) -->
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card border-0 shadow-sm h-100"
                                            style="background: linear-gradient(145deg, #ffffff, #f0fdf4); border-left: 5px solid #10b981 !important; border-radius: 10px;">
                                            <div class="card-body p-3">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <p class="text-muted small fw-bold mb-1 d-flex align-items-center">
                                                            <span class="fs-5 me-1">✅</span> Completed (Today)
                                                        </p>
                                                        <h3 class="mb-1 fw-bold text-success">
                                                            {{ number_format($cutting_completed ?? 0) }} <span
                                                                class="fs-6 fw-normal text-muted">Pcs</span>
                                                        </h3>
                                                        <span class="text-muted x-small">Today's cutting completed count</span>
                                                    </div>
                                                    <div class="rounded-circle p-2 d-flex align-items-center justify-content-center"
                                                        style="background: #dcfce7; width: 44px; height: 44px;">
                                                        <i class="ri ri-checkbox-circle-line text-success fs-5"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-md-6">
                                        <div class="card border-0 shadow-sm h-100"
                                            style="background: linear-gradient(145deg, #ffffff, #fff7ed); border-left: 5px solid #f97316 !important; border-radius: 10px;">
                                            <div class="card-body p-3">
                                                <div class="d-flex justify-content-between align-items-start">
                                                    <div>
                                                        <p class="text-muted small fw-bold mb-1 d-flex align-items-center">
                                                            <span class="fs-5 me-1">⏳</span> Pending
                                                        </p>
                                                        <h3 class="mb-1 fw-bold text-warning">
                                                            {{ number_format($cutting_pending ?? 0) }} <span
                                                                class="fs-6 fw-normal text-muted">Pcs</span>
                                                        </h3>
                                                        <span class="text-muted x-small">Target - Completed (Remaining)</span>
                                                    </div>
                                                    <div class="rounded-circle p-2 d-flex align-items-center justify-content-center"
                                                        style="background: #ffedd5; width: 44px; height: 44px;">
                                                        <i class="ri ri-hourglass-line text-warning fs-5"></i>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <!-- Reference KPI Table Layout (Matching Wireframe Image Exactly) -->
                                <div class="card border shadow-none bg-light" style="border-radius: 10px; overflow: hidden;">
                                    <div
                                        class="card-header bg-white py-2 px-3 border-bottom d-flex justify-content-between align-items-center">
                                        <span class="fw-bold small text-dark d-flex align-items-center">
                                            <i class="ri ri-list-check-2 text-warning me-1"></i> Cutting Department Operations
                                            Summary (Today)
                                        </span>
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="small text-muted">Department Efficiency:</span>
                                            <span
                                                class="badge {{ ($cutting_efficiency ?? 0) >= 80 ? 'bg-success' : (($cutting_efficiency ?? 0) >= 50 ? 'bg-warning text-dark' : 'bg-danger') }} fw-bold px-2 py-1">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover align-middle mb-0 bg-white">
                                            <thead class="bg-light">
                                                <tr>
                                                    <th class="py-2 px-3 text-dark fw-bold"
                                                        style="width: 55%; font-size: 0.85rem;">KPI</th>
                                                    <th class="py-2 px-3 text-dark fw-bold text-end"
                                                        style="width: 45%; font-size: 0.85rem;">Today</th>
                                                </tr>
                                            </thead>
                                            <tbody style="font-size: 0.9rem;">
                                                <tr>
                                                    <td class="py-2 px-3">
                                                        <span class="me-2">🧑</span> <strong>Employees Present</strong>
                                                    </td>
                                                    <td class="py-2 px-3 text-end fw-bold text-dark">
                                                        {{ $cutting_emp_present ?? 0 }} / {{ $cutting_emp_total ?? 0 }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="py-2 px-3">
                                                        <span class="me-2">✂️</span> <strong>Pieces Cut</strong>
                                                    </td>
                                                    <td class="py-2 px-3 text-end fw-bold text-primary">
                                                        {{ number_format($cutting_pieces_cut ?? 0) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="py-2 px-3">
                                                        <span class="me-2">📄</span> <strong>Active Job Cards</strong>
                                                        <a href="javascript:;" data-bs-toggle="modal"
                                                            data-bs-target="#cuttingJobCardsModal"
                                                            class="ms-2 small text-decoration-none text-info">
                                                            (View All)
                                                        </a>
                                                    </td>
                                                    <td class="py-2 px-3 text-end fw-bold text-dark">
                                                        {{ $cutting_active_job_cards ?? 0 }}
                                                        <span
                                                            class="badge bg-soft-success text-success ms-1 small">{{ $cutting_completed_job_cards ?? 0 }}
                                                            Completed</span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="py-2 px-3">
                                                        <span class="me-2">🎯</span> <strong>Target</strong>
                                                    </td>
                                                    <td class="py-2 px-3 text-end fw-bold text-danger">
                                                        {{ number_format($cutting_target ?? 0) }} Pcs
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="py-2 px-3">
                                                        <span class="me-2">✅</span> <strong>Completed</strong>
                                                    </td>
                                                    <td class="py-2 px-3 text-end fw-bold text-success">
                                                        {{ number_format($cutting_completed ?? 0) }} Pcs
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="py-2 px-3">
                                                        <span class="me-2">⏳</span> <strong>Pending</strong>
                                                        <span class="text-muted x-small ms-1">(Target - Completed)</span>
                                                    </td>
                                                    <td class="py-2 px-3 text-end fw-bold text-warning">
                                                        {{ number_format($cutting_pending ?? 0) }} Pcs
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="py-2 px-3">
                                                        <span class="me-2">📈</span> <strong>Department Efficiency</strong>
                                                    </td>
                                                    <td class="py-2 px-3 text-end fw-bold">
                                                        <span
                                                            class="badge {{ ($cutting_efficiency ?? 0) >= 80 ? 'bg-success' : (($cutting_efficiency ?? 0) >= 50 ? 'bg-warning text-dark' : 'bg-danger') }} px-2 py-1">
                                                            {{ $cutting_efficiency ?? 0 }}%
                                                        </span>
                                                    </td>
                                                </tr>
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-lg-4">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold"><i class="ri ri-focus-3-line me-2 text-primary"></i>Production
                                            Target Status</h6>
                                        <span
                                            class="badge {{ $production_efficiency >= 80 ? 'bg-success' : ($production_efficiency >= 50 ? 'bg-warning text-dark' : 'bg-danger') }}">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between mb-1">
                                                ...
                                                <span class="small fw-bold">{{ number_format($production_achieved_qty ?: 0) }} /
                                                    {{ number_format($production_plan_qty ?: 0) }}</span>
                                            </div>
                                            <div class="progress" style="height: 12px;">
                                                <div class="progress-bar {{ $production_efficiency >= 80 ? 'bg-success' : ($production_efficiency >= 50 ? 'bg-warning' : 'bg-danger') }}"
                                                    role="progressbar" style="width: {{ min(100, $production_efficiency) }}%">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="p-3 bg-light rounded text-center border">
                                            ...
                                            <h4 class="mb-0 fw-bold text-dark">
                                                {{ number_format(max(0, $production_plan_qty - ($production_achieved_qty ?: 0))) }}
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card border-0 shadow-sm h-100 border-top border-danger border-3">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold text-danger"><i class="ri ri-time-line me-2"></i>Delivery Days
                                            Overdue</h6>
                                        <span class="badge bg-soft-danger text-danger">{{ $delivery_overdue->count() }}
                                            Overdue</span>
                                    </div>
                                                ...
                                                @foreach($delivery_overdue as $od)
                                                    <div class="list-group-item py-3">
                                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                                            ...
                                                            <span class="badge bg-danger text-white">{{ $od->overdue_days }} Days
                                                                Overdue</span>
                                                        </div>
                                                        <p class="text-muted x-small mb-0">Target:
                                                            {{ date('d-M-y', strtotime($od->delivery_date)) }} | Qty:
                                                            {{ number_format($od->grand_total_qty) }}</p>
                                                    </div>
                                                @endforeach
                                            @else
                            ...
                            <div class="col-lg-4">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3">
                                        <h6 class="mb-0 fw-bold"><i class="ri ri-flow-chart me-2 text-info"></i>Process Wise
                                            Status</h6>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="table-responsive" style="max-height: 280px; overflow-y: auto;">
                                            <table class="table table-sm table-hover mb-0 align-middle">
                                                ...
                                                <tbody class="small">
                                                    @if($process_wise_status->count() > 0)
                                                        @foreach($process_wise_status as $ps)
                                                            <tr>
                                                                ...
                                                                <td class="text-center text-success fw-bold">{{ $ps->completed ?: 0 }}
                                                                </td>
                                                                <td class="text-center text-warning fw-bold">{{ $ps->in_progress ?: 0 }}
                                                                </td>
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="4" class="text-center text-muted py-3">No process data
                                                                recorded</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-7">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold"><i class="ri ri-loader-line me-2 text-primary"></i>Production
                                            WIP (Unit Wise)</h6>
                                                ...
                                                <tbody class="small">
                                                    @if($production_wip->count() > 0)
                                                        @foreach($production_wip as $wip)
                                                            <tr class="wip-row">
                                                                <td class="wip-process-name">
                                                                    <strong>{{ $wip->operation_stage_name }}</strong></td>
                                                                <td class="text-center">{{ number_format($wip->opening ?: 0, 2) }}</td>
                                                                <td class="text-center text-success">
                                                                    {{ number_format($wip->inward ?: 0, 2) }}</td>
                                                                <td class="text-center text-primary">
                                                                    {{ number_format($wip->outward ?: 0, 2) }}</td>
                                                                <td class="text-center fw-bold">{{ number_format($wip->wip ?: 0, 2) }}
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    @else
                                                        <tr>
                                                            <td colspan="5" class="text-center text-muted py-4">No WIP data
                                                                available</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                    ...
                                    <div class="card-footer bg-light border-0 py-2">
                                        <p class="mb-0 x-small text-muted">
                                            <strong>Note:</strong> Stages show if work is in progress or a task is assigned.
                                            Completed stages are hidden to keep overview clean.
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold"><i
                                                class="ri ri-money-rupee-circle-line me-2 text-success"></i>Production Cost
                                            (Unit Wise)</h6>
                                        <div class="search-box">
                                            <input type="text" id="costSearchInput" class="form-control form-control-sm"
                ...
                <div class="tab-pane fade" id="tab-stock-material" role="tabpanel" aria-labelledby="tab-stock-material-tab">
                    ...
                    <div class="mb-5">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h4 class="mb-0 fw-bold">₹{{ formatIndianCurrency($total_fabric_stock_val) }}
                                                </h4>
                        ...
                        <div class="card border-0 shadow-sm mb-5" id="accessoriesInventoryCard">
                            ...
                            <div class="card-datatable table-responsive px-3 pb-3">
                                <table class="table table-hover align-middle mb-0 small" id="accessoriesDrilldownTable"
                                    style="width: 100%;">
                                </table>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-bold text-warning">
                                                        {{ number_format($core_total_wip, 2) }}</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-bold text-success">{{ number_format($core_total_fg) }}
                                                    </h4>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-bold text-info">
                                                        {{ number_format($core_total_pipeline, 2) }}</h4>
                        ...
                        <div class="mb-4" id="fabricUtilisationSection">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4 class="mb-0 fw-bold text-danger">
                                                        {{ number_format($total_util_wastage, 2) }}</h4>
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <h4
                                                        class="mb-0 fw-bold {{ $total_util_pct >= 95 ? 'text-success' : ($total_util_pct >= 90 ? 'text-warning' : 'text-danger') }}">
                                                        {{ $total_util_pct }}%</h4>
                            ...
                            <div class="mb-3 d-flex align-items-center" id="utilBreadcrumbs" style="display: none !important;">
                                <button class="btn btn-sm btn-outline-secondary me-2" onclick="showUtilBrandLevel()"
                                    id="btnBackToUtilBrands">
                        ...
                        <div id="utilJobCardsContainer" class="card border-0 shadow-sm" style="display: none;">
                            <div
                                ...
                                <div>
                                    <h6 class="mb-0 fw-bold text-dark">
                                        <i class="ri ri-file-list-3-line me-2 text-primary"></i><span
                                            id="utilActiveBrandHeaderTitle">Job Cards</span>
                                    </h6>
            ...
            @if($canSuppliersMaint)
                <!-- ========================================================================================= -->
                <!-- TAB 5: SUPPLIERS & MAINTENANCE                                                            -->
                <div class="tab-pane fade" id="tab-suppliers-maintenance" role="tabpanel"
                    aria-labelledby="tab-suppliers-maintenance-tab">
                    ...
                    <div class="mb-5" id="supplierPerformanceSection">
                        ...
                        <div class="row g-3 mb-4">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <h4 class="mb-0 fw-bold text-success">
                                                    ₹{{ number_format($supplier_perf_spend, 2) }}</h4>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div
                                    class="card kpi-widget border-0 shadow-sm border-start {{ $supplier_perf_ontime >= 90 ? 'border-success' : ($supplier_perf_ontime >= 75 ? 'border-warning' : 'border-danger') }} border-4 h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <p class="text-muted small fw-bold mb-1">Fleet On-Time Rate</p>
                                                <h4
                                                    class="mb-0 fw-bold {{ $supplier_perf_ontime >= 90 ? 'text-success' : ($supplier_perf_ontime >= 75 ? 'text-warning' : 'text-danger') }}">
                                                    {{ $supplier_perf_ontime }}%</h4>
                        ...
                        <div id="supplierBreadcrumbs" class="align-items-center mb-3 text-muted small"
                            style="display: none !important;">
                            <a href="javascript:;" onclick="showSupplierMainLevel()" class="text-primary me-2 fw-bold"
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-7">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0 fw-bold text-navy"><i
                                                class="ri ri-shield-check-line me-2 text-primary"></i>Renewals & Statutory
                                            Compliance</h6>
                                                        ...
                                                        @foreach($expiring_documents as $doc)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    @endphp
                                                                    @if($isExpired)
                                                                        <span class="badge bg-danger text-white border px-2 py-1"><i
                                                                                class="ri ri-close-circle-line me-1"></i> Expired</span>
                                                                    @else
                                                                        <span class="badge bg-warning text-dark border px-2 py-1"><i
                                                                                class="ri ri-time-line me-1"></i> {{ $daysLeft }} Days
                                                                            Left</span>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="3" class="text-center py-4 text-muted small">
                                                                ...
                                                                All renewals up to date. No upcoming expirations in the next 90
                                                                days.
                                                            </td>
                                                        </tr>
                                                    @endif
                            ...
                            <div class="col-lg-5">
                                <div class="card border-0 shadow-sm h-100">
                                    <div class="card-header bg-white py-3">
                                        <h6 class="mb-0 fw-bold text-navy"><i
                                                class="ri ri-tools-line me-2 text-danger"></i>Maintenance Ticket Status</h6>
                                    </div>
                                    <div class="card-body p-0">
                                        <div class="list-group list-group-flush list-group-sm">
                                            <div class="list-group-item border-0 py-3 bg-light-danger-soft">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <span
                                                        class="badge bg-primary rounded-pill fs-6 px-3 py-2">{{ $maintenance_raised }}</span>
                                                </div>
                                            </div>
                                            <div class="list-group-item border-0 py-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <span class="small fw-bold text-dark d-block">Requirements
                                                            Attended</span>
                                                        <small class="text-muted">Repairs completed & resolved</small>
                                                    </div>
                                                    <span
                                                        class="badge bg-success rounded-pill fs-6 px-3 py-2">{{ $maintenance_attended }}</span>
                                                </div>
                                            </div>
                                            <div class="list-group-item border-0 py-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <span class="small fw-bold text-danger d-block">Requirements
                                                            Pending</span>
                                                        <small class="text-danger">Action required by maintenance team</small>
                                                    </div>
                                                    <span
                                                        class="badge bg-danger rounded-pill fs-6 px-3 py-2">{{ $maintenance_pending }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            @if(auth()->user()->department_id == 3 || (auth()->user()->department && stripos(auth()->user()->department->department, 'cutting') !== false))
                if (!window.location.hash) {
                    initialTab = '#tab-production';
                }
            @endif
    ...
    <!-- ========================================================================= -->
    <!-- MODAL: CUTTING JOB CARDS (ALL JOB CARDS WITH COMPLETED)                    -->
    <!-- ========================================================================= -->
    <div class="modal fade" id="cuttingJobCardsModal" tabindex="-1" aria-labelledby="cuttingJobCardsModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
                <div class="modal-header bg-primary text-white py-3 px-4">
                    <div class="d-flex align-items-center gap-2">
                        <div
                            class="rounded-circle p-2 bg-white bg-opacity-25 d-flex align-items-center justify-content-center">
                            <i class="ri ri-scissors-cut-line text-white fs-5"></i>
                        </div>
                        <div>
                            <h5 class="modal-title text-white mb-0 fw-bold" id="cuttingJobCardsModalLabel">Cutting
                                Department Job Cards</h5>
                            <p class="mb-0 text-white-50 x-small">Active & Completed Job Cards for Cutting Department</p>
                        </div>
                    </div>
                        ...
                        <div class="search-box" style="min-width: 260px;">
                            <div class="input-group input-group-sm">
                                <span class="input-group-text bg-light border-end-0"><i
                                        class="ri ri-search-line text-muted"></i></span>
                                <input type="text" id="cuttingJcSearchInput" class="form-control border-start-0"
                                    placeholder="Search Job Card, Brand, Style...">
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover align-middle mb-0" id="cuttingJobCardsTable">
                            <thead class="bg-light sticky-top">
                                <tr>
                                    ...
                                    <th class="small">Job Card No</th>
                                    <th class="small">Brand</th>
                                    <th class="small">Style</th>
                                    <th class="small">Unit</th>
                                    <th class="small">Delivery Date</th>
                                    <th class="small text-end">Order Qty</th>
                                    <th class="small text-end">Pieces Cut</th>
