                                        ...
                                        @if($task->assignments && $task->assignments->count() > 0)
                                            @foreach($task->assignments as $index => $assign)
                                                @php
                                                    ...
                                                    if($assign->status == 'Completed') $statusColor = 'success';
                                                    if($assign->status == 'In Progress') $statusColor = 'info';

                                                    $qcStatusColor = 'secondary';
                                                    if($assign->qc_status == 'QC Completed') $qcStatusColor = 'success';
                                                    if($assign->qc_status == 'In QC') $qcStatusColor = 'info';
                                                @endphp
