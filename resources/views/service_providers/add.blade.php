        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ url('service_providers/add' . ($serviceProvider ? '/' . $serviceProvider->id : '')) }}" method="POST" class="common-form" autocomplete="off">
                        @csrf
                        <div class="row g-4">
                            <div class="col-lg-12">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Enter Name" name="name" value="{{ old('name', $serviceProvider->name ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" placeholder="Enter Code" name="code" value="{{ old('code', $serviceProvider->code ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter Email" name="email" value="{{ old('email', $serviceProvider->email ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('mobile_no') is-invalid @enderror" id="mobile_no" placeholder="Enter Mobile Number" name="mobile_no" value="{{ old('mobile_no', $serviceProvider->mobile_no ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <select name="service_rate" id="service_rate" class="select2 form-select @error('service_rate') is-invalid @enderror" data-placeholder="Select Service Rate">
                                        <option value="">Select Service Rate</option>
                                        <option value="Per Agent" {{ old('service_rate', $serviceProvider->service_rate ?? '') == 'Per Agent' ? 'selected' : '' }}>Per Agent</option>
                                        <option value="Job Type" {{ old('service_rate', $serviceProvider->service_rate ?? '') == 'Job Type' ? 'selected' : '' }}>Job Type</option>
                                    </select>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <select name="state_id" id="state_id" class="select2 form-select @error('state_id') is-invalid @enderror" data-placeholder="Select State">
                                        ...
                                        <option value="{{ $state->id }}" {{ old('state_id', $serviceProvider->state_id ?? '') == $state->id ? 'selected' : '' }}>{{ $state->state_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <select name="city_id" id="city_id" class="select2 form-select @error('city_id') is-invalid @enderror" data-placeholder="Select City">
                                        ...
                                        <option value="{{ $city->id }}" {{ old('city_id', $serviceProvider->city_id ?? '') == $city->id ? 'selected' : '' }}>{{ $city->city_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <select name="place_id" id="place_id" class="select2 form-select @error('place_id') is-invalid @enderror" data-placeholder="Select Place">
                                        ...
                                        <option value="{{ $place->id }}" {{ old('place_id', $serviceProvider->place_id ?? '') == $place->id ? 'selected' : '' }}>{{ $place->place_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('address_line_2') is-invalid @enderror" id="address_line_2" placeholder="Enter Address Line 2" name="address_line_2" value="{{ old('address_line_2', $serviceProvider->address_line_2 ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('contact_person_name') is-invalid @enderror" id="contact_person_name" placeholder="Enter Contact Person Name" name="contact_person_name" value="{{ old('contact_person_name', $serviceProvider->contact_person_name ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('pan_no') is-invalid @enderror" id="pan_no" placeholder="Enter PAN No" name="pan_no" value="{{ old('pan_no', $serviceProvider->pan_no ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('gst_no') is-invalid @enderror" id="gst_no" placeholder="Enter GST No" name="gst_no" value="{{ old('gst_no', $serviceProvider->gst_no ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('bank_name') is-invalid @enderror" id="bank_name" placeholder="Enter Bank Name" name="bank_name" value="{{ old('bank_name', $serviceProvider->bank_name ?? '') }}">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control @error('bank_acc_no') is-invalid @enderror" id="bank_acc_no" placeholder="Enter Bank Account No" name="bank_acc_no" value="{{ old('bank_acc_no', $serviceProvider->bank_acc_no ?? '') }}">
