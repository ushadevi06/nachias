...
<head>
    ...
    <title>Courier Sticker - {{ $invoice->inv_no }}</title>
    <style>
        @page {
            size: 100mm 150mm;
            margin: 0;
...
<body onload="{{ isset($is_print) && $is_print ? 'window.print()' : '' }}">
    <div class="sticker">
        ...
        <div class="section phone-section">
            <div class="icon-box circle" style="margin-bottom: 0;">
                <svg viewBox="0 0 24 24">
                    <path d="M6.62 10.79a15.149 15.149 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.27c1.12.37 2.33.57 3.57.57a1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1c0 1.24.2 2.45.57 3.57a1 1 0 01-.27 1.11l-2.2 2.2z"/>
                </svg>
            </div>
            <div class="phone-val">{{ $invoice->customer->mobile_no ?? 'N/A' }}</div>
        </div>
