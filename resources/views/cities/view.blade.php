...
@section('title', 'City - ' . env('WEBSITE_NAME'))
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="table-header-box">
                <h4>Cities</h4>
                <a class="btn btn-primary" href="{{ url('add_city') }}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-box">
                                            <a href="{{ url('add_city') }}" title="Edit" class="btn btn-edit"><i class="icon-base ri ri-edit-box-line"></i></a>
