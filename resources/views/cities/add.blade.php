...
@section('title', 'Add City - ' . env('WEBSITE_NAME'))
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" class="common-form">
                        <div class="row g-4 justify-content-center">
                            ...
                            <div class="col-md-6 col-xl-12">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="country-name" placeholder="Enter City" name="name">
                                    <label for="country-name">City *</label>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-12">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" id="country-name" placeholder="Enter Pincode" name="pincode">
                                    <label for="country-name">Pincode</label>
                                </div>
                            </div>
                            <div class="col-md-6 col-xl-12">
                                <div class="form-floating form-floating-outline">
