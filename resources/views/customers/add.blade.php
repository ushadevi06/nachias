                        ...
                        <form action="{{ url('customers/add' . ($customer ? '/' . $customer->id : '')) }}" method="POST"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <label class="form-label d-block mb-2">Category <span
                                            class="text-danger">*</span></label>
                                    <div class="d-flex align-items-center gap-4">
                                        <div class="form-check">
                                            <input class="form-check-input @error('category') is-invalid @enderror"
                                                type="radio" name="category" id="category_retailer" value="Retailer" {{ old('category', $customer->category ?? '') == 'Retailer' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="category_retailer">Retailer</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input @error('category') is-invalid @enderror"
                                                type="radio" name="category" id="category_wholesaler" value="Wholesaler" {{ old('category', $customer->category ?? '') == 'Wholesaler' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" class="form-control @error('website_url') is-invalid @enderror"
                                            id="website_url" placeholder="Enter Website URL" name="website_url"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            ...
                                            id="transport_name" placeholder="Enter Transport Name" name="transport_name"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            class="form-control @error('booking_office') is-invalid @enderror"
                                            id="booking_office" placeholder="Enter Booking Office" name="booking_office"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            ...
                                            id="address_line_3" placeholder="Enter Address Line 3" name="address_line_3"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" class="form-control @error('designation') is-invalid @enderror"
                                            id="designation" placeholder="Enter Contact Person Designation"
                                            name="designation"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text"
                                            class="form-control @error('contact_mobile_no') is-invalid @enderror"
                                            id="contact_mobile_no" placeholder="Enter Contact Person Mobile Number"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="email"
                                            ...
                                            id="contact_email" placeholder="Enter Contact Person Email" name="contact_email"
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <select name="tax_type_id" id="tax_type_id"
                                            ...
                                            @foreach($taxes as $tax)
                                                <option value="{{ $tax->id }}" {{ old('tax_type_id', $customer->tax_type_id ?? '') == $tax->id ? 'selected' : '' }}>{{ $tax->item_name }}
                                                    ({{ $tax->tax_rate }}%)</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="number" step="0.01"
                                            ...
                                            id="credit_limit" placeholder="Enter Credit Limit" name="credit_limit"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="number" step="0.01"
                                            class="form-control @error('sales_discount') is-invalid @enderror"
                                            id="sales_discount" placeholder="Enter Sales Discount" name="sales_discount"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" class="form-control @error('branch') is-invalid @enderror"
                                            id="branch" placeholder="Enter Branch" name="branch"
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" class="form-control @error('ifsc_code') is-invalid @enderror"
                                            id="ifsc_code" placeholder="Enter IFSC Code" name="ifsc_code"
