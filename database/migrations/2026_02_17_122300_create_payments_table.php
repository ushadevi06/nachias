...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payments', function (Blueprint $schema) {
            ...
            $schema->string('payment_type', 50); // Customer Collection, Supplier Payment, Agent Commission
            $schema->string('reference_type', 50)->nullable(); // Sales Invoice, Purchase Invoice, Debit Note
            $schema->bigInteger('reference_id')->unsigned()->nullable();
            $schema->string('reference_no', 100)->nullable(); // For static or external references
