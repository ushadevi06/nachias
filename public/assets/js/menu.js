      ...
      a = (function () {
        function e(t) {
          ...
          if (
            ...
            r
              ? ((this._scrollbar = new r(t.querySelector(".menu-inner"), {
                  suppressScrollX: !0,
          ...
          window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT
            ...
            "true" ===
              localStorage.getItem(
                "templateCustomizer-".concat(templateName, "--SemiDark")
              ) &&
              document
        ...
        return (
            ...
            (n = [
                {
                    ...
                    value: function () {
                        ...
                        (this._evntElClick = function (n) {
                            ...
                            var o = n.target.classList.contains("menu-toggle")
                                ? n.target
                                : e._findParent(n.target, "menu-toggle", !1);
                            o &&
                                (n.preventDefault(),
                                "true" !== o.getAttribute("data-hover") &&
                                    t.toggle(o));
                        }),
                                ...
                                this._showDropdownOnHover &&
                                    ((this._evntElMouseOver = function (e) {
                                        if (
                                            ...
                                            var n = e.target.classList.contains(
                                                "menu-toggle"
                                            )
                                                ? e.target
                                                : null;
                                    ...
                                    (this._evntElMouseOut = function (n) {
                                        ...
                                        if (
                                            (o.closest("ul") &&
                                                ...
                                                (t._topParent = o),
                                            o !== i &&
                                                (o.parentNode.classList.contains(
                                                    "open"
                                                ) ||
                                                ...
                                                r &&
                                                r.parentNode &&
                                                !r.parentNode.classList.contains(
                                                    "menu-link"
                                                ))
                                        ) {
                                            if (
                                                ...
                                                !e.childOf(
                                                    r,
                                                    t._topParent.parentNode
                                                )
                                            ) {
                                                var s =
                                                    t._topParent.classList.contains(
                                                        "menu-toggle"
                                                    )
                                                        ? t._topParent
                                                        : null;
                ...
                },
                {
                    ...
                    value: function (t, n) {
                        for (
                            var i = e._findChild(t.parentNode, [
                                    "menu-item",
                                    "open",
                                ]),
                                o = 0,
                ...
                },
                {
                    ...
                    value: function (t, n, i) {
                        ...
                        if (t) {
                            ...
                            s
                                ? u + this._innerPosition + 2 * d > l &&
                                  d < l &&
                                  d >= c &&
                                  (o.style.left = [
                                      this._rtl ? "100%" : "-100%",
                                  ])
                                : u + this._innerPosition + d > l &&
                                  d < l &&
                                  d > c &&
                                  (o.style[
                            ...
                            if (
                                (h.length &&
                                    h[0].removeAttribute("data-hover", "true"),
                ...
                },
                {
                    key: "_slide",
                    value: function (e) {
                        var wrapperWidth = Math.round(
                            this._wrapper.getBoundingClientRect().width
                        );
                        var innerWidth = this._innerWidth;
                        var t;
                        if (e === "next") {
                            t = this._getSlideNextPos();
                            var minPosition = wrapperWidth - innerWidth;
                            if (t < minPosition + 50) {
                              t = minPosition;
                              console.log(minPosition);
                            }
                        } else {
                            t = this._getSlidePrevPos();
                            if (t > 0) t = 0;
                        }
                ...
                },
                {
                    ...
                    value: function (t, n) {
                        ...
                        for (
                            var r = 0,
                                s = (i = i.slice(0, i.indexOf(o))).length;
                            r < s;
                            r++
                        )
                            if ((i[r].classList.add("open"), this._accordion))
                                for (
                                    var l = e._findChild(i[r].parentNode, [
                                            "menu-item",
                                            "open",
                                        ]),
                                        a = 0,
                ...
                },
                {
                    ...
                    value: function (e) {
                        for (
                            var t = this._inner.childNodes[0], n = 0;
                            t !== e;
                        ...
                        window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT
                            ...
                            o > i &&
                                ...
                                (0 === r
                                    ...
                                    : this._prevBtn.classList.remove(
                                          "disabled"
                                      ),
                                o + r <= i
                    ...
                    value: function (t) {
                        ...
                        if ("vertical" === t) {
                            ...
                            (this._horizontal = !1),
                                ...
                                (m = s.classList).remove.apply(
                                    m,
                                    i(s.classList)
                                ),
                                (_ = s.classList).add.apply(
                                    _,
                                    [
                                        "layout-menu",
                                        "menu",
                                        "menu-vertical",
                                    ].concat([this._menuBgClass])
                                ),
                                u.classList.remove("d-none", "d-lg-flex"),
                                c.classList.remove("d-none"),
                                void 0 !== h &&
                                    (this._psScroll = new h(
                                        document.querySelector(".menu-inner"),
                                        {
                                            suppressScrollX: !0,
                                            wheelPropagation: !e._hasClass(
                            ...
                            (this._horizontal = !0),
                                ...
                                (p = s.classList).remove.apply(
                                    p,
                                    i(s.classList)
                                ),
                                (f = s.classList).add.apply(
                                    f,
                                    [
                        ...
                        localStorage.getItem(
                            "templateCustomizer-".concat(
                                templateName,
                                "--SemiDark"
                            )
                        ) && s.setAttribute("data-bs-theme", "dark"),
                            this._bindEvents();
                    },
                },
                {
                    ...
                    value: function () {
                        if (this._el) {
                            this._unbindEvents();
                            for (
                                var t = this._el.querySelectorAll(".menu-item"),
                                    n = 0,
                                    i = t.length;
                                n < i;
                                n++
                            ...
                            this._el.classList.remove("menu-no-animation"),
                                this._wrapper &&
                                    (this._prevBtn.parentNode.removeChild(
                                        this._prevBtn
                                    ),
                                    this._nextBtn.parentNode.removeChild(
                                        this._nextBtn
                                    ),
                                    ...
                                    this._wrapper.parentNode.removeChild(
                                        this._wrapper
                                    ),
            ...
            (o = [
                ...
                },
                {
                    ...
                    value: function (e, t) {
                        ...
                        if (
                            ...
                            throw new Error(
                                "Cannot find `.".concat(t, "` parent element")
                            );
                        return e;
                    },
                },
                {
                    ...
                    value: function (e, t) {
                        for (
                            var n = e.childNodes, i = [], o = 0, r = n.length;
                            o < r;
                            o++
                        )
                            if (n[o].classList) {
                    ...
                    value: function (t, n) {
                        ...
                        if (
                            (t.classList.contains("menu-item")
                                ? e._findChild(t, [o]).length && (i = t)
                                : t.classList.contains(o) &&
                                  (i = t.parentNode.classList.contains(
                                      "menu-item"
                                  )
                                      ? t.parentNode
                                      : null),
                ...
                },
                {
                    ...
                    value: function (t, n) {
                        var i = function (i) {
                                i.target === t &&
                                    (e._unbindAnimationEndEvent(t), n(i));
                            },
                            o = window.getComputedStyle(t).transitionDuration;
                        (o =
                            parseFloat(o) * (-1 !== o.indexOf("ms") ? 1 : 1e3)),
                            (t._menuAnimationEndEventCb = i),
                            l.forEach(function (e) {
                                return t.addEventListener(
                                    e,
                                    t._menuAnimationEndEventCb,
                                    !1
                                );
                            }),
                            (t._menuAnimationEndEventTimeout = setTimeout(
                                function () {
                                    i({ target: t });
                                },
                                o + 50
                ...
                },
                {
                    key: "setDisabled",
                    value: function (t, n) {
                        e._getItem(t, !1).classList[n ? "add" : "remove"](
                            "disabled"
                        );
                    },
                },
