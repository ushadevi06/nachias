            ...
            var o = 1e3,
              ...
              u = function (e, t, n, s) {
                ...
                if (
                  ...
                  e.dispatchEvent(o);
                  var a = r._steps.filter(function (e) {
                      return e.classList.contains(c.ACTIVE);
                    }),
                    u = r._stepsContents.filter(function (e) {
                      return e.classList.contains(c.ACTIVE);
                    });
                  o.defaultPrevented ||
                  ...
                  this._steps
                    ...
                    .forEach(function (e) {
                      s._stepsContents.push(
                        s._element.querySelector(e.getAttribute("data-target"))
                      );
                    }),
              ...
              return (
                (n._setLinkListeners = function () {
                  ...
                  this._steps.forEach(function (t) {
                    ...
                    e.options.linear
                      ? ((e._clickStepLinearListener = L(e.options)),
                        n.addEventListener("click", e._clickStepLinearListener))
                      : ((e._clickStepNonLinearListener = E(e.options)),
                        n.addEventListener(
                          "click",
                ...
                (n.next = function () {
                  ...
                  u(this._element, t, this.options, function () {
                    e._currentIndex = t;
                  });
                }),
                (n.previous = function () {
                ...
                (n.to = function (e) {
                  ...
                  u(this._element, s, this.options, function () {
                    t._currentIndex = s;
                  });
                }),
                (n.reset = function () {
                  var e = this;
                  u(this._element, 0, this.options, function () {
                    e._currentIndex = 0;
                  });
                }),
                (n.destroy = function () {
