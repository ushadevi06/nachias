!(function (e, t) {
  ...
  else if ("function" == typeof define && define.amd) define(["fetch"], t);
  else {
      ...
      (function () {
        ...
        const e = (e) => "string" == typeof e,
          ...
          l = (t, o, n) => {
            ...
            return a(t) ? {} : { obj: t, k: s(i[r]) };
          },
          c = (e, t, o) => {
            const { obj: n, k: s } = l(e, t, Object);
            if (void 0 !== n || 1 === t.length) return void (n[s] = o);
            let i = t[t.length - 1],
          ...
          u = (e, t) => {
            ...
            if (o && Object.prototype.hasOwnProperty.call(o, n)) return o[n];
          },
          h = (t, o, n) => {
            for (const s in o)
              "__proto__" !== s &&
          ...
          emit(e) {
            ...
            if (this.observers[e]) {
              Array.from(this.observers[e].entries()).forEach((e) => {
                let [t, n] = e;
                for (let e = 0; e < n; e++) t(...o);
              });
            }
            if (this.observers["*"]) {
              Array.from(this.observers["*"].entries()).forEach((t) => {
                let [n, s] = t;
                for (let t = 0; t < s; t++) n.apply(n, [e, ...o]);
              });
            }
          }
        }
        class O extends w {
          ...
          addResource(e, t, o, n) {
            ...
            o && (r = r.concat(i ? o.split(i) : o)),
              e.indexOf(".") > -1 && ((r = e.split(".")), (n = t), (t = r[1])),
          ...
          addResources(t, o, n) {
            let s =
              arguments.length > 3 && void 0 !== arguments[3]
                ...
                : { silent: !1 };
            for (const s in n)
              (e(n[s]) || Array.isArray(n[s])) &&
                this.addResource(t, o, s, n[s], { silent: !0 });
        ...
        class P extends w {
          ...
          extractFromKey(t, o) {
            ...
            if (r && !a) {
              ...
              if (o && o.length > 0)
                return { key: t, namespaces: e(i) ? [i] : i };
              const r = t.split(n);
              (n !== s || (n === s && this.options.ns.indexOf(r[0]) > -1)) &&
                (i = r.shift()),
                (t = r.join(s));
            }
            return { key: t, namespaces: e(i) ? [i] : i };
          ...
          translate(t, o, n) {
            ...
            const s =
              ...
              i =
                void 0 !== o.keySeparator
                  ? o.keySeparator
                  : this.options.keySeparator,
              { key: r, namespaces: a } = this.extractFromKey(
                t[t.length - 1],
                o
              ),
              l = a[a.length - 1],
            ...
            if (
              ...
              if (y && e(m) && Array.isArray(p))
                (p = p.join(m)), p && (p = this.extendTranslation(p, t, o, n));
              else {
                let s = !1,
                  a = !1;
                const u = void 0 !== o.count && !e(o.count),
                  ...
                  f =
                    o.ordinal && u
                      ? this.pluralResolver.getSuffix(c, o.count, {
                          ordinal: !1,
                        })
                      : "",
                  ...
                  y =
                    ...
                    o[`defaultValue${f}`] ||
                    o.defaultValue;
                !this.isValidLookup(p) && d && ((s = !0), (p = y)),
                  this.isValidLookup(p) || ((a = !0), (p = r));
                const v =
                ...
                if (a || s || b) {
                  ...
                  if ("fallback" === this.options.saveMissingTo && t && t[0])
                    for (let o = 0; o < t.length; o++) e.push(t[o]);
                  else
                  ...
                  const n = (e, t, n) => {
                    ...
                    this.options.missingKeyHandler
                      ? this.options.missingKeyHandler(e, l, t, s, b, o)
                      : this.backendConnector?.saveMissing &&
                        this.backendConnector.saveMissing(e, l, t, s, b, o),
              ...
              if (!o.returnObjects && !this.options.returnObjects) {
                ...
                const e = this.options.returnedObjectHandler
                  ? this.options.returnedObjectHandler(d, p, { ...o, ns: a })
              ...
              if (i) {
                ...
                for (const e in p)
                  if (Object.prototype.hasOwnProperty.call(p, e)) {
                    const s = `${n}${i}${e}`;
                    (t[e] = this.translate(s, { ...o, joinArrays: !1, ns: a })),
                      t[e] === s && (t[e] = p[e]);
                  }
                p = t;
              }
            ...
            return s
              ? ((h.res = p), (h.usedParams = this.getUsedParamsDetails(o)), h)
              : p;
          }
                  ...
                  (t = this.interpolator.nest(
                    ...
                    function () {
                      for (
                        ...
                        t[s] = arguments[s];
                      return i?.[0] !== t[0] || n.context
                        ? r.translate(...t, o)
                        : (r.logger.warn(
                            `It seems you are nesting recursively key: ${t[0]} in key: ${o[0]}`
                          ),
                          null);
                    },
                    n
            ...
            return (
              ...
              t.forEach((t) => {
                ...
                const h = void 0 !== a.count && !e(a.count),
                  ...
                  d =
                    void 0 !== a.context &&
                    (e(a.context) || "number" == typeof a.context) &&
                    "" !== a.context,
                  g = a.lngs
                    ? a.lngs
                ...
                u.forEach((e) => {
                  this.isValidLookup(o) ||
                    ...
                    L[`${g[0]}-${e}`] ||
                      ...
                      this.logger.warn(
                        `key "${n}" for languages "${g.join(
                          ", "
                        )}" won't get resolved as namespace "${r}" was not yet loaded`,
                    ...
                    g.forEach((t) => {
                        ...
                        if (
                          (h &&
                            ...
                            a.ordinal &&
                              0 === e.indexOf(s) &&
                              n.push(
                                c + e.replace(s, this.options.pluralSeparator)
                              ),
                            p && n.push(c + o)),
                          d)
                        ) {
                          ...
                          n.push(t),
                            h &&
                              ...
                              a.ordinal &&
                                0 === e.indexOf(s) &&
                                n.push(
                                  t + e.replace(s, this.options.pluralSeparator)
                                ),
                              p && n.push(t + o));
                        }
                      }
                      ...
                      for (; (r = n.pop()); )
                        this.isValidLookup(o) ||
                          ((s = r), (o = this.getResource(t, e, r, a)));
                    }));
                });
              }),
              { res: o, usedKey: n, exactUsedKey: s, usedLng: i, usedNS: r }
            );
          }
          isValidLookup(e) {
            return !(
          ...
          getResource(e, t, o) {
            ...
            return this.i18nFormat?.getResource
              ? this.i18nFormat.getResource(e, t, o, n)
              : this.resourceStore.getResource(e, t, o, n);
          }
          getUsedParamsDetails() {
            ...
            let s = n ? t.replace : t;
            if (
              (n && void 0 !== t.count && (s.count = t.count),
              this.options.interpolation.defaultVariables &&
                (s = { ...this.options.interpolation.defaultVariables, ...s }),
              !n)
            ) {
              s = { ...s };
              for (const e of o) delete s[e];
            }
            return s;
          }
        ...
        class j {
              ...
              !t &&
                ...
                e.forEach((e) => {
                  ...
                  t = this.options.supportedLngs.find((e) =>
                    e === o
                      ? e
                      : e.indexOf("-") < 0 && o.indexOf("-") < 0
                      ? void 0
                      : (e.indexOf("-") > 0 &&
                          o.indexOf("-") < 0 &&
                          e.substring(0, e.indexOf("-")) === o) ||
                        (0 === e.indexOf(o) && o.length > 1)
                      ? e
                      : void 0
                  );
                }),
          ...
          getFallbackCodes(t, o) {
            ...
            let n = t[o];
            return (
              n || (n = t[this.getScriptPartFromCode(o)]),
          ...
          toResolveHierarchy(t, o) {
            ...
            return (
              e(t) && (t.indexOf("-") > -1 || t.indexOf("_") > -1)
                ...
                : e(t) && i(this.formatLanguageCode(t)),
              n.forEach((e) => {
        ...
        const R = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 },
          C = {
        ...
        class $ {
          ...
          getRule(e) {
            ...
            const o = v("dev" === e ? "en" : e),
              ...
              s = JSON.stringify({ cleanedCode: o, type: n });
            if (s in this.pluralRulesCache) return this.pluralRulesCache[s];
            let i;
            try {
              i = new Intl.PluralRules(o, { type: n });
            } catch (o) {
              if (!Intl)
                return (
                  this.logger.error(
          ...
          getSuffixes(e) {
            ...
            return (
              ...
              o
                ? o
                    .resolvedOptions()
                    .pluralCategories.sort((e, t) => R[e] - R[t])
                    .map(
                      (e) =>
        ...
        class D {
            ...
            return (
              [
                { regex: this.regexpUnescape, safeValue: (e) => E(e) },
                {
                  regex: this.regexp,
                  safeValue: (e) =>
                    this.escapeValue ? E(this.escape(e)) : E(e),
                },
              ].forEach((n) => {
                for (l = 0; (r = n.regex.exec(t)); ) {
                  ...
                  if (((a = u(s)), void 0 === a))
                    if ("function" == typeof h) {
                      ...
                      this.logger.warn(
                        `missed to pass in variable ${s} for interpolating ${t}`
                      ),
                        (a = "");
                    }
                  else e(a) || this.useRawValueToEscape || (a = o(a));
                  const c = n.safeValue(a);
                  if (
                    ((t = t.replace(r[0], c)),
                    p
                      ? ((n.regex.lastIndex += a.length),
                        (n.regex.lastIndex -= r[0].length))
                      : (n.regex.lastIndex = 0),
                    l++,
                    l >= this.maxReplaces)
                  )
          ...
          nest(t, n) {
            ...
            const l = (e, t) => {
              ...
              let s = `{${n[1]}`;
              (e = n[0]), (s = this.interpolate(s, r));
              const i = s.match(/'/g),
                a = s.match(/"/g);
              (((i?.length ?? 0) % 2 == 0 && !a) || a.length % 2 != 0) &&
                (s = s.replace(/'/g, '"'));
              try {
            ...
            for (; (s = this.nestingRegexp.exec(t)); ) {
              ...
              e(i) || (i = o(i)),
                i ||
                  (this.logger.warn(
                    `missed to resolve ${s[1]} for nesting ${t}`
                  ),
                  (i = "")),
                u &&
                  (i = c.reduce(
        ...
        class F {
          constructor() {
            ...
            (this.logger = S.create("formatter")),
              ...
              (this.formats = {
                number: T((e, t) => {
                  const o = new Intl.NumberFormat(e, { ...t });
                  return (e) => o.format(e);
                }),
                currency: T((e, t) => {
                ...
                relativetime: T((e, t) => {
                  const o = new Intl.RelativeTimeFormat(e, { ...t });
                  return (e) => o.format(e, t.range || "day");
                }),
                list: T((e, t) => {
                  const o = new Intl.ListFormat(e, { ...t });
                  return (e) => o.format(e);
                }),
              }),
              this.init(e);
          ...
          format(e, t, o) {
            ...
            return s.reduce((e, t) => {
              const { formatName: s, formatOptions: i } = ((e) => {
                ...
                return { formatName: t, formatOptions: o };
              })(t);
              if (this.formats[s]) {
                let t = e;
                try {
              ...
              return (
                this.logger.warn(`there was no format function for ${s}`), e
              );
            }, e);
          }
        }
        class I extends w {
          ...
          queueLoad(e, t, o, n) {
            ...
            return (
              e.forEach((e) => {
                ...
                t.forEach((t) => {
                  const r = `${e}|${t}`;
                  !o.reload && this.store.hasResourceBundle(e, t)
                    ? (this.state[r] = 2)
                    : this.state[r] < 0 ||
                      (1 === this.state[r]
                        ? void 0 === i[r] && (i[r] = !0)
          ...
          loaded(e, t, o) {
            ...
            t && this.emit("failedLoading", s, i, t),
              !t &&
                o &&
                this.store.addResourceBundle(s, i, o, void 0, void 0, {
                  skipCopy: !0,
                }),
              (this.state[e] = t ? -1 : 2),
              t && o && (this.state[e] = 0);
            ...
            this.queue.forEach((o) => {
              ((e, t, o, n) => {
                ...
                0 !== o.pendingCount ||
                  o.done ||
                  (Object.keys(o.loaded).forEach((e) => {
                    r[e] || (r[e] = {});
                    const t = o.loaded[e];
                    t.length &&
                      t.forEach((t) => {
          ...
          reload(e, t, o) {
            this.prepareLoading(e, t, { reload: !0 }, o);
          }
          loadOne(e) {
            let t =
              arguments.length > 1 && void 0 !== arguments[1]
            ...
            this.read(n, s, "read", void 0, void 0, (o, i) => {
              o &&
                this.logger.warn(
                  `${t}loading namespace ${s} for language ${n} failed`,
                  o
                ),
                !o &&
                  i &&
                  this.logger.log(
                    `${t}loaded namespace ${s} for language ${n}`,
                    i
                  ),
                this.loaded(e, o, i);
            });
          ...
          saveMissing(e, t, o, n, s) {
            ...
            if (
              ...
              this.logger.warn(
                `did not save key "${o}" as the namespace "${t}" was not yet loaded`,
                "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!"
              );
          }
        }
        const A = () => ({
          ...
          U = (t) => (
            ...
            "boolean" == typeof t.initImmediate &&
              (t.initAsync = t.initImmediate),
            t
          ),
          M = () => {};
        class V extends w {
          constructor() {
            ...
            if (
              ...
              (o = this),
              Object.getOwnPropertyNames(Object.getPrototypeOf(o)).forEach(
                (e) => {
          ...
          init() {
            ...
            const i = A();
            (this.options = { ...i, ...this.options, ...U(n) }),
              (this.options.interpolation = {
                ...i.interpolation,
                ...this.options.interpolation,
              }),
          ...
          reloadResources(e, o, n) {
            ...
            return (
              ...
              "function" == typeof o && ((n = o), (o = void 0)),
              e || (e = this.languages),
              o || (o = this.options.ns),
              n || (n = M),
            ...
            const i = function (e, t) {
              ...
              if ("object" != typeof t) {
                for (
                  ...
                  a[l - 2] = arguments[l];
                o = s.options.overloadTranslationOptionHandler(
                  [e, t].concat(a)
                );
              } else o = { ...t };
              (o.lng = o.lng || i.lng),
          ...
          cloneInstance() {
            ...
            if (
              ...
              (s.store = new O(e, n)), (s.services.resourceStore = s.store);
            }
            return (
              (s.translator = new P(s.services, n)),
        ...
        var X,
          W,
          Q = "function" == typeof fetch ? fetch : void 0;
        if (
        ...
        var G = function (e, t) {
          ...
          Y = function (e, t, o, n) {
            var s = function (e) {
              if (!e.ok)
                return o(e.statusText || "Error", { status: e.status });
              e.text()
                .then(function (t) {
            ...
            if (n) {
              var i = n(e, t);
              if (i instanceof Promise) return void i.then(s).catch(o);
            }
            "function" == typeof fetch
              ? fetch(e, t).then(s).catch(o)
              : Q(e, t).then(s).catch(o);
          },
          Z = !1,
          ee = function (e, t, o, n) {
            return (
              ...
              Q && 0 !== t.indexOf("file:")
                ...
                : K() || "function" == typeof ActiveXObject
                ? (function (e, t, o, n) {
                    o && "object" === J(o) && (o = G("", o).slice(1)),
                      e.queryStringParams && (t = G(t, e.queryStringParams));
                    try {
                      var s = X ? new X() : new W("MSXML2.XMLHTTP.3.0");
                      ...
                      if ((i = "function" == typeof i ? i() : i))
                        for (var r in i) s.setRequestHeader(r, i[r]);
                      (s.onreadystatechange = function () {
                        s.readyState > 3 &&
                          n(s.status >= 400 ? s.statusText : null, {
                            status: s.status,
                            data: s.responseText,
                          });
                      }),
                ...
                : void n(new Error("No fetch and no xhr implementation found!"))
            );
          };
        function te(e) {
          return (
        ...
        function ne(e) {
          for (var t = 1; t < arguments.length; t++) {
            var o = null != arguments[t] ? arguments[t] : {};
            t % 2
              ? oe(Object(o), !0).forEach(function (t) {
                  ie(e, t, o[t]);
                })
              : Object.getOwnPropertyDescriptors
              ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(o))
              : oe(Object(o)).forEach(function (t) {
                  Object.defineProperty(
                    e,
                    t,
                    Object.getOwnPropertyDescriptor(o, t)
              ...
              value: function (e, t, o, n) {
                ...
                this.options.request(this.options, e, a, function (i, r) {
                  if (r && ((r.status >= 500 && r.status < 600) || !r.status))
                    return t(
                      "failed loading " + e + "; status code: " + r.status,
                      !0
                    );
        ...
        var ye = {
          ...
          lookup(e) {
            ...
            if (t && me()) return window.localStorage.getItem(t) || void 0;
          },
          cacheUserLanguage(e, t) {
        ...
        var xe = {
            ...
            lookup(e) {
              ...
              if (t && be()) return window.sessionStorage.getItem(t) || void 0;
            },
            cacheUserLanguage(e, t) {
          ...
          init() {
            ...
            (this.services = e),
              (this.options = (function (e) {
                return (
                  ue.call(ce.call(arguments, 1), (t) => {
                    if (t) for (const o in t) void 0 === e[o] && (e[o] = t[o]);
                  }),
                  e
                );
              })(t, this.options || {}, {
