!(function (e, t) {
  ...
  return (function () {
    ...
    function fe(e) {
      return B(K(e)).left + ue(e).scrollLeft;
    }
    function de(e) {
      var t = q(e),
        n = t.overflow,
    ...
    function ye(e, t) {
      ...
      var n = t,
        ...
        C = e.rects.popper,
        x = e.elements[k ? T : b],
        S = me(L(x) ? x : x.contextElement || K(e.elements.popper), g, _, u),
        j = B(e.elements.reference),
        P = _e({
          reference: j,
          element: C,
          strategy: "absolute",
        ...
        if (C) {
          if (l) {
            var F,
              ...
              ie = $(0, x[B], J[B]),
              re = A
                ? x[B] / 2 - K - ie - te - j.mainAxis
                : Q - ie - te - j.mainAxis,
              oe = A
                ? -x[B] / 2 + K + ie + ne + j.mainAxis
                : U + ie + ne + j.mainAxis,
          ...
          if (d) {
            var fe,
              ...
              we = _e ? ge : pe - x[ve] - S[ve] - be + j.altAxis,
              ke = _e ? pe + x[ve] + S[ve] - be - j.altAxis : me,
              Ee =
                _ && _e
                  ? (function (e, t, n) {
                      var i = $(e, t, n);
      ...
      wt = function (e, t) {
        if (
          ...
          var n =
            ...
            i = !1;
          t.addEventListener(at, function n(r) {
            r.target === t && ((i = !0), t.removeEventListener(at, n), bt(e));
          }),
            setTimeout(function () {
              i || ct(t);
            }, n);
    ...
    var zt = function (e, t, n) {
      ...
      Kt = function (e, t) {
        return Bt(e.getAttribute("data-bs-".concat(Rt(t))));
      },
      Qt = (function () {
        function e() {
          Qe(this, e);
          ...
          return (
            ...
            (e = ut(e))
              ? ((i._element = e),
                ...
                it(i._element, i.constructor.DATA_KEY, Be(i)),
                i)
              : Fe(i)
          );
        }
      ...
      en = (function (e) {
        function t() {
          return Qe(this, t), Me(this, t, arguments);
        }
        return (
          Re(t, e),
          Xe(
    ...
    var an = ".bs.swipe",
      ...
      Fn = (function (e) {
        function t(e, n) {
          ...
          return (
            Qe(this, t),
            ((i = Me(this, t, [e, n]))._interval = null),
            ...
            [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this._config.ride &&
                    (this._isSliding
                      ? Ht.one(this._element, kn, function () {
                          return e.cycle();
                        })
                      : this.cycle());
                },
              ...
              },
              {
                ...
                value: function () {
                  this._swipeHelper && this._swipeHelper.dispose(),
                    Ne(We(t.prototype), "dispose", this).call(this);
                },
              },
              {
                key: "_configAfterMerge",
    ...
    var Hn = ".".concat("bs.collapse"),
      ...
      Gn = (function (e) {
        function t(e, n) {
          var i;
          Qe(this, t),
            ((i = Me(this, t, [e, n]))._isTransitioning = !1),
            (i._triggerArray = []);
          var r,
            o = Ge(Yt.find(Xn));
          try {
    ...
    var Jn = "dropdown",
      ...
      gi = _t() ? "bottom-end" : "bottom-start",
      mi = _t() ? "bottom-start" : "bottom-end",
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  if (
                    "object" ===
                      tt(
                        (e = Ne(We(t.prototype), "_getConfig", this).call(
                          this,
                          e
                        )).reference
                      ) &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  i.length && kt(i, n, t === ni, !i.includes(n)).focus();
                },
              },
            ],
            [
    ...
    Ht.on(document, ci, fi, ki.dataApiKeydownHandler),
      Ht.on(document, ci, hi, ki.dataApiKeydownHandler),
    ...
    var Ei = "backdrop",
      ...
      xi = (function (e) {
        function t(e) {
          ...
          return (
            Qe(this, t),
            ((n = Me(this, t))._config = n._getConfig(e)),
            (n._isAppended = !1),
            (n._element = null),
            n
          );
      ...
      Qi = "shown".concat(Ri),
      Ui = "resize".concat(Ri),
      Xi = "click.dismiss".concat(Ri),
      Yi = "mousedown.dismiss".concat(Ri),
      ...
      ir = (function (e) {
        function t(e, n) {
          ...
          return (
            Qe(this, t),
            ((i = Me(this, t, [e, n]))._dialog = Yt.findOne(
              ".modal-dialog",
              i._element
            )),
    ...
    var Tr = {
      ...
      Sr = (function (e) {
        function t(e) {
          var n;
          return Qe(this, t), ((n = Me(this, t))._config = n._getConfig(e)), n;
        }
        return (
          Re(t, e),
          Xe(
            ...
            [
              ...
              },
              {
                key: "_typeCheckConfig",
                value: function (e) {
                  Ne(We(t.prototype), "_typeCheckConfig", this).call(this, e),
                ...
                value: function (e) {
                  for (var n = 0, i = Object.entries(e); n < i.length; n++) {
                    var r = $e(i[n], 2),
                      o = r[0],
                      a = r[1];
                    Ne(We(t.prototype), "_typeCheckConfig", this).call(
                      this,
                      { selector: o, entry: a },
                      xr
                    );
      ...
      Br = (function (e) {
        function t(e, i) {
          var r;
          if ((Qe(this, t), void 0 === n))
            throw new TypeError(
              "Bootstrap's tooltips require Popper (https://popper.js.org)"
            );
          return (
            ((r = Me(this, t, [e, i]))._isEnabled = !0),
            (r._timeout = 0),
            (r._isHovered = null),
            (r._activeTrigger = {}),
            (r._popper = null),
    ...
    var Vr = ".".concat("bs.scrollspy"),
      ...
      eo = (function (e) {
        function t(e, n) {
          ...
          return (
            Qe(this, t),
            ((i = Me(this, t, [e, n]))._targetLinks = new Map()),
    ...
    var to = ".".concat("bs.tab"),
      ...
      Eo = "".concat(wo, ", ").concat(ko),
      Ao = "."
        .concat(go, '[data-bs-toggle="tab"], .')
        .concat(go, '[data-bs-toggle="pill"], .')
        .concat(go, '[data-bs-toggle="list"]'),
      Oo = (function (e) {
        function t(e) {
          var n;
          return (
            Qe(this, t),
            ((n = Me(this, t, [e]))._parent = n._element.closest(
    ...
    Ht.on(document, ao, ko, function (e) {
      ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
