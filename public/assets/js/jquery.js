          ...
          !(function (t, n) {
            ...
            !(function () {
              ...
              function Z(e, t, n, r) {
                ...
                if (!r && (ue(t), (t = t || u), f)) {
                  ...
                  if (!(C[e + " "] || (p && p.test(e)))) {
                    if (
                      ((d = e), (h = t), 1 === m && ($.test(e) || F.test(e)))
                    ) {
                      for (
                        ((h = (G.test(e) && se(t.parentNode)) || t) == t &&
                          v.scope) ||
                          ((s = t.getAttribute("id"))
                    ...
                    (S = function (e, t) {
                      ...
                      return (
                        ...
                        (!v.sortDetached && t.compareDocumentPosition(e) === n)
                          ? e === u ||
                            (e.ownerDocument == P && Z.contains(P, e))
                            ? -1
                            : t === u ||
              ...
              function ve(e) {
                for (
                  ...
                  if ((i = t.relative[e[l].type])) d = [pe(de(d), i)];
                    ...
                    if (
                      (i = t.filter[e[l].type].apply(null, e[l].matches))[y]
                    ) {
              ...
              function me(e, n, r, i) {
                ...
                if (((r = r || []), 1 === p.length)) {
                  if (
                    ...
                    if (
                      !(n = (t.find.ID(s.matches[0].replace(Q, Y), n) || [])[0])
                    )
                      return r;
                    c && (n = n.parentNode),
                  ...
                  for (
                    ...
                    if (
                      (l = t.find[u]) &&
                      (i = l(
                        s.matches[0].replace(Q, Y),
                        (G.test(a[0].type) && se(n.parentNode)) || n
                      ))
                    ) {
            ...
            (E.filter = function (e, t, n) {
              ...
              E.fn.extend({
                ...
                is: function (e) {
                  return !!$(
                    this,
                    "string" == typeof e && W.test(e) ? E(e) : e || [],
                    !1
                  ).length;
                },
              });
                ...
                function (e, t) {
                  E.fn[e] = function (n, r) {
                    ...
                    return (
                      ...
                      this.length > 1 &&
                        (X[e] || E.uniqueSort(i), z.test(e) && i.reverse()),
                      this.pushStack(i)
                    );
                  };
                }
            ...
            function ze(e, t) {
              ...
              if (1 === t.nodeType) {
                ...
                ue.hasData(e) &&
                  ((o = ue.access(e)), (a = E.extend({}, o)), ue.set(t, a));
              }
            }
            function Xe(e, t) {
            ...
            function Ue(e, t, n, r) {
              ...
              if (
                ...
                if (s)
                  for (
                    c = a[a.length - 1].ownerDocument, E.map(a, Be), f = 0;
                    f < s;
                    f++
                  )
                    (l = a[f]),
            ...
            E.extend({
              ...
              clone: function (e, t, n) {
                ...
                if (t)
                  if (n)
                    for (
                      o = o || De(e), a = a || De(s), r = 0, i = o.length;
                      r < i;
                      r++
                    )
                      ze(o[r], a[r]);
            ...
            function lt(e, t, n, r, i, o) {
              ...
              for (; a < 4; a += 2)
                "margin" === n && (l += E.css(e, n + he[a], !0, i)),
                  r
                    ? ("content" === n &&
                        (u -= E.css(e, "padding" + he[a], !0, i)),
                      "margin" !== n &&
                        (u -= E.css(e, "border" + he[a] + "Width", !0, i)))
                    : ((u += E.css(e, "padding" + he[a], !0, i)),
                      "padding" !== n
                        ? (u += E.css(e, "border" + he[a] + "Width", !0, i))
                    ...
                    : ((n = jt(e)),
                      this.each(function () {
                        if (s)
                          ...
                          (void 0 !== e && "boolean" !== a) ||
                            ((r = kt(this)) && se.set(this, "__className__", r),
                            this.setAttribute &&
                              this.setAttribute(
                                "class",
                                r || !1 === e
            ...
            E.ajaxSetup({
                  ...
                  return (
                    ...
                    n.always(function () {
                      void 0 === o ? E(r).removeProp(i) : (r[i] = o),
                        e[i] &&
                          ((e.jsonpCallback = t.jsonpCallback), tn.push(i)),
                        a && y(o) && o(a[0]),
                        (a = o = void 0);
                    }),
                    "script"
              ...
              E.each(["top", "left"], function (e, t) {
                E.cssHooks[t] = et(v.pixelPosition, function (e, n) {
                  if (n)
                    return (
                      (n = Ze(e, t)), Ge.test(n) ? E(e).position()[t] + "px" : n
                    );
                });
              }),
