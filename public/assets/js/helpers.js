        ...
        var a,
          ...
          u =
            ...
            getComputedStyle(document.documentElement)
              .getPropertyValue("--bs-min-contrast-ratio")
              .trim(),
      ...
      showActiveTheme: function (e) {
        ...
        if (n) {
          ...
          var s = Array.from(i.classList).filter(function (e) {
            return !e.startsWith("ri-");
          });
          i.setAttribute("class", "ri-".concat(a, " ").concat(s.join(" ")));
          var u = ""
